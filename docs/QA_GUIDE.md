...
| Fair Queue concurrency | Have two host queue reorder actions occur close together | Event-scoped reorder operations serialize and leave one consistent queue order with both authorized actions audited. |
